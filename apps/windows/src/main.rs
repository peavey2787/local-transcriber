...
fn run() -> Result<()> {
    ...
    let viewport = egui::ViewportBuilder::default()
        ...
        .with_icon(egui::IconData {
            rgba: transcriber_ui::tray_icon::mic_icon_rgba(transcriber_ui::tray::APP_ICON_SIZE),
            width: transcriber_ui::tray::APP_ICON_SIZE,
            height: transcriber_ui::tray::APP_ICON_SIZE,
        })
