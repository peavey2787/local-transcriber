...
`scripts/linux/prepare-sherpa-runtime.sh` rejects any archive whose digest differs
...
`scripts/linux/cargo-lock-inventory.py` compares every package name, release, source
